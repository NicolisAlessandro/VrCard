...
def queryHandler(update, context):
    global domanda,stamp_to_screen_monument, torna_alle, categ, nscelta, index_monument, frase, nposti
    ...
    if "🇬🇧 / 🇺🇸 English" in query:
        ...
        buttons=[
            [InlineKeyboardButton("Map",callback_data="engmap_")],
    ...
    if "Grafici" in query:
        ...
        frase = "graf_"
        buttons=[
            [InlineKeyboardButton("2014",callback_data="graf_2014")],
            [InlineKeyboardButton("2015",callback_data="graf_2015")],
            [InlineKeyboardButton("2016",callback_data="graf_2016")],
            [InlineKeyboardButton("2017",callback_data="graf_2017")],
            [InlineKeyboardButton("2018",callback_data="graf_2018")],
            [InlineKeyboardButton("2019",callback_data="graf_2019")],
            [InlineKeyboardButton("2020",callback_data="graf_2020")],
            [InlineKeyboardButton("Indietro",callback_data="🇮🇹 Italiano")]
            ]
    ...
    if "Jur_Church" in query:
        ...
        buttons=[
        [InlineKeyboardButton("Chu1",callback_data="Jur_Chu1")],
        [InlineKeyboardButton("Chu1",callback_data="Jur_Chu2")],
        [InlineKeyboardButton("Chu1",callback_data="Jur_Chu3")],
        [InlineKeyboardButton("Chu1",callback_data="Jur_Chu4")],
    ...
    if (str(frase)+ "_Monumenti") in query:
        ...
        for i in range (0, len(name_mon)):
            ...
            buttons.append(
                [InlineKeyboardButton(name_monument_str,callback_data=index_monument)]
                ) 
        buttons.append(
            [InlineKeyboardButton("Indietro",callback_data="scegli")]
            )
    ...
    if "scegli" in query:
        ...
        if nscelta==1:
            ...
            buttons=[
                ...
                [InlineKeyboardButton("Musei ",callback_data="map__Musei ")],
                [InlineKeyboardButton("chiese",callback_data="map__Chiese")],
                [InlineKeyboardButton("Back/Indietro",callback_data="Mappa")]
                ]
            update.callback_query.edit_message_text(reply_markup=InlineKeyboardMarkup(buttons),  text="mappa")
    ...
    if "123Back" in query:
        ...
        if nscelta==1:
            ...
            frase="engmap_"
            nscelta = 1
            buttons=[[InlineKeyboardButton("Monuments",callback_data="map__Monuments")], 
            [InlineKeyboardButton("Museum ",callback_data="map__Museum ")],
            [InlineKeyboardButton("Church",callback_data="engmap__Church")],
            [InlineKeyboardButton("Back/Indietro",callback_data="🇮🇹 Italiano")]
            ]
            update.callback_query.edit_message_text(reply_markup=InlineKeyboardMarkup(buttons),  text="mappa")
            ...
            nscelta=2
            frase="Jur_"
            buttons=[[InlineKeyboardButton("Monuments",callback_data="Jur__Monuments")], 
            [InlineKeyboardButton("Museum",callback_data="Jur__Museum")],
            [InlineKeyboardButton("Church",callback_data="Jur__Church")],
            [InlineKeyboardButton("Back/Indietro",callback_data="🇬🇧 / 🇺🇸 English")]
            ]
            update.callback_query.edit_message_text(reply_markup=InlineKeyboardMarkup(buttons),  text="Where we droppin' bois?")
            ...
            frase="graf_"
            buttons=[
                [InlineKeyboardButton("Monuments",callback_data="graf__Monuments")], 
                [InlineKeyboardButton("Museum",callback_data="graf__Museum")],
                [InlineKeyboardButton("Church",callback_data="graf__Church")],
                [InlineKeyboardButton("Back/Indietro",callback_data="🇬🇧 / 🇺🇸 English")]
                ]
            update.callback_query.edit_message_text(reply_markup=InlineKeyboardMarkup(buttons),  text="Graphs: ")
