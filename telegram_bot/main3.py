...
def queryHandler(update, context):
    ...
    if "🇬🇧 / 🇺🇸 English" in query:
        ...
        buttons=[[InlineKeyboardButton("Map",callback_data="emap_")],[InlineKeyboardButton("Jurney",callback_data="Jurney")], [InlineKeyboardButton("Graphs",callback_data="Graphs")],[InlineKeyboardButton("Back/Indietro",callback_data="Back/Indietro")]]
    ...
    if (str(frase)+ "Monuments") in query:
        ...
        for i in range (0, len(name_mon)):
            ...
            buttons.append([InlineKeyboardButton(name_monument_str,callback_data=index_monument)]) 
        buttons.append([InlineKeyboardButton("back",callback_data="123back")])
        update.callback_query.edit_message_text(reply_markup=InlineKeyboardMarkup(buttons),  text="quale Monumento??")
